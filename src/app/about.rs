...
pub fn dialog_script() -> String {
    ...
    <div class="box" role="dialog" aria-modal="true" aria-labelledby="about-title">
      <div class="head">
        <svg class="logo" viewBox="0 0 620 180" role="img" aria-labelledby="about-title">
          <title id="about-title">MediaFlick Desktop</title>
          <defs>
          ...
          <text x="188" y="86" fill="#e8e8e8" font-family="Inter, Segoe UI, sans-serif" font-size="48" font-weight="700" letter-spacing="-1.8">MediaFlick</text>
          <text x="191" y="132" fill="#aaa" font-family="Inter, Segoe UI, sans-serif" font-size="31" font-weight="600" letter-spacing="3.4">DESKTOP</text>
        </svg>
  ...
  host.addEventListener('mediaflick-desktop-about-focus', () => xButton.focus());
  xButton.focus();
}})();"##
    )
}
