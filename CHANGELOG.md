...
- Carried the home screen's cinematic visual language through library browsing, search, discovery, requests, item details, sign-in, dialogs, empty states, and the player bar, with shared red interaction accents, stronger page hierarchy, translucent surfaces, and consistent card motion.
