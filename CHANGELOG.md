...
- Added the React toolchain under `ui/` with Vite, TypeScript, Tailwind CSS v4, shadcn/ui on `radix-ui`, TanStack Query, React Router, and `@tanstack/react-virtual`. Tailwind uses CSS-first configuration. `build.rs` installs the frozen UI dependencies and builds the bundle into `OUT_DIR`, so `cargo build` cannot embed stale files or an out-of-date lockfile. Use `just ui` or `just ui-dev` to work on the UI alone.
...
- PRs authored by `phob` now skip CI jobs, including the required aggregate check, so small maintainer changes can merge without waiting for the full suite. All other PRs, including dependency bots, and pushes to `main` still run full CI.
...
- Updated the Rust toolchain and application dependencies, including Rust 1.98.1, CEF 152, `rusqlite` 0.40.2, `ureq` 3.4.1, `sevenz-rust2` 0.22, and `getrandom` 0.4 ([#33](https://github.com/phob/MediaFlick-Desktop/pull/33), [#64](https://github.com/phob/MediaFlick-Desktop/pull/64), [#93](https://github.com/phob/MediaFlick-Desktop/pull/93), [#124](https://github.com/phob/MediaFlick-Desktop/pull/124), [#131](https://github.com/phob/MediaFlick-Desktop/pull/131), [#133](https://github.com/phob/MediaFlick-Desktop/pull/133) by [@renovate](https://github.com/apps/renovate)).
- Updated the UI toolchain and dependencies, including Node 24, pnpm 12, TypeScript 7, React 19.2.8, Vite 8.2.2, Vitest 5, React Router 7.18.3, TanStack Query 5.102.8, TanStack Virtual 3.14.12, Oxlint 1.82.0, and Lucide 1.45.0 ([#37](https://github.com/phob/MediaFlick-Desktop/pull/37), [#38](https://github.com/phob/MediaFlick-Desktop/pull/38), [#53](https://github.com/phob/MediaFlick-Desktop/pull/53), [#88](https://github.com/phob/MediaFlick-Desktop/pull/88), [#115](https://github.com/phob/MediaFlick-Desktop/pull/115), [#119](https://github.com/phob/MediaFlick-Desktop/pull/119), [#122](https://github.com/phob/MediaFlick-Desktop/pull/122), [#126](https://github.com/phob/MediaFlick-Desktop/pull/126), [#129](https://github.com/phob/MediaFlick-Desktop/pull/129), [#139](https://github.com/phob/MediaFlick-Desktop/pull/139), [#141](https://github.com/phob/MediaFlick-Desktop/pull/141) by [@renovate](https://github.com/apps/renovate)).
- Updated Companion development to .NET SDK 10.0.401, Microsoft.NET.Test.Sdk 18.9.0, and xUnit v4 ([#74](https://github.com/phob/MediaFlick-Desktop/pull/74), [#75](https://github.com/phob/MediaFlick-Desktop/pull/75), [#136](https://github.com/phob/MediaFlick-Desktop/pull/136) by [@renovate](https://github.com/apps/renovate)).
- Updated CI to Node 24, `actions/setup-node` v7, `actions/setup-dotnet` v6, and `pnpm/action-setup` v6, and refreshed locked Rust and UI dependencies ([#36](https://github.com/phob/MediaFlick-Desktop/pull/36), [#40](https://github.com/phob/MediaFlick-Desktop/pull/40), [#47](https://github.com/phob/MediaFlick-Desktop/pull/47), [#130](https://github.com/phob/MediaFlick-Desktop/pull/130) by [@renovate](https://github.com/apps/renovate)).
