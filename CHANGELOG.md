...
- Added a release-century filter to Seerr's film and series catalogues. It composes with genre, rating, and sort controls, uses exact inclusive release/first-air date ranges, and keeps the selected tab and filters in the URL when opening a title and returning to discovery.
