...
- A watched title is now marked with a finished progress rule along the foot of its artwork instead of a corner badge. The two states mean the same thing, and in a library that is mostly watched the badge put eighty bright marks on a single screen and the artwork lost. The rule is dimmed, because "seen" is the resting state and a half-watched title is the one worth spotting.
